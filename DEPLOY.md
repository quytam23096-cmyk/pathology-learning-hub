...
1. Đưa các file `index.html`, `styles.css`, `app.js`, `README.md`, `DEPLOY.md` lên repository GitHub.
...
- Tính năng đổi ảnh đang lưu trên trình duyệt của người dùng. Muốn ảnh đổi cho mọi người, hãy thay URL ảnh trong `app.js` rồi push lại GitHub.
